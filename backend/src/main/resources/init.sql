...
-- 2. 테이블은 Spring Boot 실행 시 JPA(ddl-auto: update)가 자동 생성합니다.
--    서버를 한 번 실행한 후 아래 INSERT 문을 실행하세요.

-- 3. 메뉴 초기 데이터 삽입
INSERT INTO menu_items (name, name_en, price, category, img_path, description, is_best) VALUES
-- NEW
...
('더블 불고기 버거', 'Double Bulgogi Burger', 5200, 'single', '/images/shrimp_jalapeno_burger.png', '진한 불고기 소스에 재운 패티 두 장으로 구성된 버거', false),
('치즈버거', 'Cheese Burger', 3300, 'single', '/images/bulgogi_burger.png', '고소하고 부드러운 치즈와 100% 순 쇠고기 패티로 구성된 클래식 치즈버거', false),
...
('핫크리스피 디럭스 버거', 'HotCrispy Deluxe Burger', 5900, 'single', '/images/shrimp_jalapeno_burger.png', '100% 통닭다리살 겉바속촉 케이준 치킨 패티 치킨 버거', false),
...
-- SET
('불고기 버거 세트', 'Bulgogi Burger Set', 6200, 'set', '/images/burger_set.png', '불고기 버거 세트', false),
('더블불고기 버거세트', 'Double Bulgogi Burger Set', 7500, 'set', '/images/burger_set.png', '더블 불고기 버거 세트', false),
('치즈버거 세트', 'Cheese Burger Set', 5500, 'set', '/images/burger_set.png', '치즈버거 세트', false),
('데리버거 세트', 'Teri Burger Set', 5600, 'set', '/images/burger_set.png', '데리버거 세트', true),
('치킨버거 세트', 'Chicken Burger Set', 6300, 'set', '/images/burger_set.png', '치킨버거 세트', false),
('핫크리스피 디럭스 버거세트', 'HotCrispy Deluxe Burger Set', 7800, 'set', '/images/burger_set.png', '핫크리스피 버거 세트', true),
('토마토치즈비프 버거 세트', 'Tomato Cheese Beef Burger Set', 5600, 'set', '/images/burger_set.png', '토마토치즈비프 버거 세트', false),
-- DRINK
...
-- SIDE
('치킨너겟', 'Chicken Nugget', 2700, 'side', '/images/nuggets.png', '닭안심살과 닭가슴살로 만든 치킨너겟 (5조각+소스)', false),
('후렌치 후라이', 'French Fries', 2200, 'side', '/images/frenchfries.png', '통으로 썰어낸 감자를 튀겨낸 바삭한 감자튀김', true),
('골든 모짜렐라 치즈스틱', 'Golden Mozzarella Cheese Sticks', 2400, 'side', '/images/cheese_stick.png', '통 모짜렐라 치즈에 튀김옷을 입혀 만든 치즈스틱 (2조각)', false),
('바닐라 아이스크림콘', 'Vanilla Ice Cream Cone', 1300, 'side', '/images/ice_cream.png', '신선한 우유로 만든 부드러운 아이스크림콘', true),
('코울슬로', 'Coleslaw', 1900, 'side', '/images/coleslaw.png', '양배추, 당근, 양파가 마요네즈 드레싱과 어우러진 샐러드', false),
('사이드소스', 'Sauce', 500, 'side', '/images/source.png', '치킨너겟, 감자튀김용 소스 (칠리맛)', false);
